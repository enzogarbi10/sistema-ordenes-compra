...
class ClienteListView(LoginRequiredMixin, ListView):
    model = Cliente
    template_name = 'ordenes/lista_clientes.html'
...
class ClienteCreateView(LoginRequiredMixin, SuperUserRequiredMixin, CreateView):
    ...
    template_name = 'ordenes/form_cliente.html'
...
class ClienteDeleteView(LoginRequiredMixin, SuperUserRequiredMixin, DeleteView):
    model = Cliente
    template_name = 'ordenes/confirmar_borrado_cliente.html'
    success_url = reverse_lazy('lista_clientes')
...
def crear_orden(request):
    ...
    return render(request, 'ordenes/form_orden.html', {
        'form': form,
        'formset': formset,
...
class EstadisticasView(LoginRequiredMixin, TemplateView):
    template_name = 'ordenes/estadisticas.html'
...
class UsuarioListView(LoginRequiredMixin, SuperUserRequiredMixin, ListView):
    model = User
    template_name = 'ordenes/lista_usuarios.html'
...
class UsuarioCreateView(LoginRequiredMixin, SuperUserRequiredMixin, CreateView):
    ...
    template_name = 'ordenes/form_usuario.html'
...
class UsuarioPasswordChangeView(LoginRequiredMixin, SuperUserRequiredMixin, FormView):
    ...
    template_name = 'ordenes/cambiar_password_usuario.html'
    success_url = reverse_lazy('lista_usuarios')
...
class UsuarioDeleteView(LoginRequiredMixin, SuperUserRequiredMixin, DeleteView):
    model = User
    template_name = 'ordenes/confirmar_borrado_usuario.html'
    success_url = reverse_lazy('lista_usuarios')
